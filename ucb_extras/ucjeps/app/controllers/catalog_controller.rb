...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.index.thumbnail_presenter = Blacklight::ThumbnailPresenter
    ...
    # FACET FIELDS
    config.add_facet_field 'majorgroup_s', label: 'Major Group', limit: true
    ...
    config.add_facet_field 'cultivated_s', label: 'Cultivated', limit: true
    ...
    config.add_search_field 'collector_ss', label: 'Collector'
    ...
    config.add_search_field 'locality_s', label: 'Locality'
    config.add_search_field 'collectors_verbatim_s', label: 'Collector(s)'
    ...
    config.add_search_field 'phase_s', label: 'Phase'
    config.add_search_field 'habitat_s', label: 'Habitat'
    config.add_search_field 'previousdeterminations_ss', label: 'Previous determinations'
    # config.add_search_field 'habitat_s', label: 'Habitat'
    # config.add_search_field 'habitat_s', label: 'Habitat'
    # config.add_search_field 'habitat_s', label: 'Habitat'
    ...
    config.add_show_field 'majorgroup_s', label: 'Major Group'
    config.add_show_field 'family_s', label: 'Family'
    config.add_show_field 'cultivated_s', label: 'Cultivated?'
    config.add_show_field 'habitat_s', label: 'Habitat'
    config.add_show_field 'elevation_s', label: 'Elevation'
    config.add_show_field 'locality_ss', label: 'Locality'
    config.add_show_field 'alllocalities_ss', label: 'All Localities'
    ...
    config.add_show_field 'collstate_ss', label: 'Collection State'
    config.add_show_field 'collcounty_ss', label: 'Collection County'
    config.add_show_field 'collcountry_ss', label: 'Collection Country'
    config.add_show_field 'previousdeterminations_ss', label: 'Previous Determinations'
    ...
    config.add_index_field 'ucbgaccessionnumber_s', label: 'UCBG Accession Number'
    config.add_index_field 'majorgroup_s', label: 'Major Group'
    config.add_index_field 'family_s', label: 'Family'
    config.add_index_field 'determination_s', label: 'Determination'
    config.add_index_field 'collectiondate_s', label: 'Collection Date'

    # sort
    config.index.title_field = 'determination_s'
