...
module SearchHistoryConstraintsHelper
  ...
  def render_search_to_s(params, accessible_label = '')
    return render(Blacklight::ConstraintsComponent.for_search_history(search_state: search_state)) unless overridden_search_history_constraints_helper_methods?
